  ...
  return (
    <header className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center text-white px-6 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="btn-hero hover:cursor-pointer bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl">
              Highlights
            </button>
            <button className="btn-hero bg-transparent hover:cursor-pointer border-2 border-red-500 text-red-500 hover:bg-red-500 hover:text-white font-semibold py-4 px-8 rounded-lg text-lg transition-all duration-300 transform hover:scale-105 shadow-xl">
            Join Team
            </button>
          </div>
      ...
      <div className="absolute bottom-8 left-1/2 scroll-arrow z-10">
        <div className="w-12 h-16 border-2 border-white rounded-full flex justify-center items-center cursor-pointer hover:border-blue-400 transition-colors">
